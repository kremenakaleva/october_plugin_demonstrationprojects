...
class CreatePolicyPartnersDemonstrationsTable extends Migration
{
    public function up()
    {
        Schema::create('pensoft_policy_partners_demonstrations', function (Blueprint $table) {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('pensoft_policy_partners_demonstrations');
    }
}